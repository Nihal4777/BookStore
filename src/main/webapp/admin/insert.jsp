...
<%
	if(request.getMethod().equalsIgnoreCase("POST")){
		...
		PreparedStatement ps=con.prepareStatement("insert into books(name,price,publisher,author,image) values(?,?,?,?,?);");
		...
		<form method="post" enctype="multipart/form-data">
			<table border=0>
				...
				<tr>
					...
					<td>
						<input type="text" name="publisher" required></td>
					</td>
				</tr>
				<tr>
					<td><label>Price: </label></td>
					<td><input type="number" name="price" requried min='1'></td>
				</tr>
				<tr>
					<td><label>Description: </label></td>
					<td>
						<div id="ta"><textarea name="description" rows="10"></textarea></div>
					</td>
				</tr>
				<tr>
					<td><label>Choose image: </label></td>
					<td><input type="file" name="img" required accept="image/*"></td>
				</tr>
				<tr>
